...
FALLBACK_MODELS = [
    ...
    "gemini-exp-1206",                # Экспериментальная декабрь
    "gemini-2.0-flash-lite",          # Lite версия - очень быстрая
    "gemini-2.0-flash",               # Стандартная 2.0
    "gemini-1.5-flash",               # Стабильная 1.5
    "gemini-1.5-flash-latest",        # Последняя 1.5
]
